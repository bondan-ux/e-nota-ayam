...
def generate_image_nota(tgl, bakul, group, items, total_bayar, logo_path):
  ...
  # --- PENYESUAIAN FONT AGAR SAMA TEBAL & BESAR DENGAN VERSI WORD/PDF ---
  bold_fonts = [
      "arialbd.ttf",
      "DejaVuSans-Bold.ttf",
  ...
  # Ukuran diperbesar dan ditebalkan agar sebanding dengan file PDF
